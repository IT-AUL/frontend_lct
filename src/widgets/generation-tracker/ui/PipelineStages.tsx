  ...
  return (
    <section className={styles.root} aria-labelledby={titleId}>
      ...
      <p className={styles.note}>
        {view.mode === 'opaque'
          ? 'Сервис пока не сообщает текущий этап, поэтому конвейер показан целиком, без процентов. Аудит идёт внутри генерации: вариант не считается готовым, пока не проверен.'
          : 'Аудит идёт внутри генерации: вариант не считается готовым, пока не проверен.'}
      </p>
    </section>
  )
}
