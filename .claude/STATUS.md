...
**Обновлено:** 2026-09-26 21:20 · **Фаза:** 4 — аудит 5 ролями, этап 1 правок фронта готов (ветка `new/festive-newton-hlnl7c`, в `main` ещё не влит), ждём доработок бэка (`docs/BACKEND_HANDOFF.md`), заморозка

**На проде сейчас:** фронт `06f51e8` ([прогон #36](https://github.com/IT-AUL/frontend_lct/actions/runs/36252837432), 26.09 18:43 МСК — код до правок аудита), бэк — по `/api/v1/version` (последний известный `87c1a6d`;
...
0. **Аудит 5 ролями (26.09) — `docs/18-ux-audit-2026-09-26.md`:** этап 1 (все P0/P1/P2 фронта) ✅ в ветке `new/festive-newton-hlnl7c`, доки синхронизированы. Осталось: влить в `main` (→ деплой), прогнать `e2e:live` на правках, этап 3 — демо с LLM и пункты бэка из `docs/18` «Бэкенд / демо».
