...
**Обновлено:** 2026-09-25 21:38 · **Фаза:** 4 — совместимость с живым бэком подтверждена, полировка, заморозка
...
| CP-11 | Совместимость с живым бэком + подключение новых ручек по `docs/16` | 29.09 | 🟡 | живой путь проверен на 7 шаблонах ✅; новых ручек у бэка пока нет — адаптеры не переключались |
...
3. Ручка бэка, если появится (HTML-экспорт, план до вёрстки, PNG-превью) — переключить адаптеры (CP-11).
