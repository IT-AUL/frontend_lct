...
**Обновлено:** 2026-09-26 14:45 · **Фаза:** 4 — деплой на VPS работает, живой бэк проверен на 7 шаблонах, ждём доработок бэка (`docs/BACKEND_HANDOFF.md`), заморозка

**На проде сейчас:** фронт `8160b06`, бэк `87c1a6d` (выкачен 26.09 14:41 МСК, [прогон #33](https://github.com/IT-AUL/frontend_lct/actions/runs/36239123928),
...
0. **Аудит 5 ролями (26.09) — `docs/18-ux-audit-2026-09-26.md`:** сначала P0/P1 фронта из таблицы «делаем сами» (шапка аудита на 1280, достижимый финал «0 блокеров», группировка аудита по правилу, опрос с backoff, ленивый pdf.js), затем демо с LLM.
